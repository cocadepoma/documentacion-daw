<nav class="navbar-dark bg-dark">
    <div class="d-flex justify-content-between">
        <div class="d-flex justify-content-evenly">
            <a class="nav-link" href="./admin-area.php">Dashboard</a>
            <ul class="navbar-nav">
        ...
        <div class="align-self-center">
            <span class="text-white"><?php echo "Bienvenido/a " . $_SESSION['user']; ?></span>
            <a href="login.php?close_session=true">Cerrar Sesión</a>
        </div>
